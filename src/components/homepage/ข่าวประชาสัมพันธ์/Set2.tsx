...
import { Data67 } from "@components/database/Database";
      ...
      <Dialog open={open} handler={handleOpen}>
        <DialogBody className="h-[36rem] overflow-scroll mt-2  ">
          <Typography className=" ">
            <>
              <div className="text-xl text-center">Set 2</div>
              <p className="text-xs">
                ...
                เเถมเด็กหน้าตาดี ไม่น้อยหน้าครู 🥰 <br /> 👉เเล้วพรุ่งนี้ เจอกัน
                  ...
                  {Data67.map((Data67) => (
                    <div className="mb-4 group relative shadow-lg rounded-xl px-[144px] py-[144px]  ">
                      <div
                        ...
                        style={{
                          backgroundImage: `url(${Data67.img67})`,
                        }}
                      />
                    </div>
                  ))}

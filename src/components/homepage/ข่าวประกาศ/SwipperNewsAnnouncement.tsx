...
import { NewsAnnouncement } from "@components/database/ข่าวประกาศ/DataNewsAnnouncement";

import "swiper/css";
import "swiper/css/pagination";
import "swiper/css/free-mode";

export default function SwipperNewsAnnouncement() {
  return (
    <>

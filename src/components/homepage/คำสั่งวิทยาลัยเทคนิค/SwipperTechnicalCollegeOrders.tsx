...
import { DataNewsAnnouncement } from "@/components/database/คำสั่งวิทยาลัยเทคนิค/DataTechnicalCollegeOrders";

export default function SwipperTechnicalCollegeOrders() {
  return (
    <>

...
import { DataNewsletterPublicRelations } from "@components/database/DataNewsletterPublicRelations";

import "swiper/css";
import "swiper/css/pagination";
import "swiper/css/free-mode";

export default function SwipperNewsletterPublicRelations() {
  return (
    <>
      <div className="flex items-center justify-center flex-col ">
        ...
        >
          ...
          {DataNewsletterPublicRelations.map((item) => (
